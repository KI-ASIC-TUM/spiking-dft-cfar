...
def main():
    ...
    fname = "../data/BBM/scenario4/samples_ch_3_scenario4.txt"
    data_cube = snn_dft_cfar.utils.read_data.bbm_get_datacube(fname)[:, :900]

    raw_data = data_cube[15]
    coded = snn_dft_cfar.dft.linear_rate_encoding(raw_data, params).sum(axis=2)
    ...
    ax2.plot(coded[0, :], color="tab:red")
    plt.show()
