...
def example_1d(chirp, FT, CFAR, guarding_cells, neighbour_cells, scale_factor,
               k, zero_padding, t_max, t_min, x_max, x_min):
    """
    ...
    print_benchmark_message(fft_time, fft_to_cfar_time, cfar.processing_time,
                            cfar.processing_time / cfar.results.size, sim_time,
                            sim_time / cfar.results.size)
...
def main(filename="../data/BBM/scenario1/samples_ch_1_scenario1.txt", dims=1):
    ...
    if dims == 2:
        ...
        example_1d(data_cube[chirp_n], FT, CFAR, guarding_cells,
                   neighbour_cells, scale_factor, k, zero_padding, t_max,
                   t_min, x_max, x_min)
